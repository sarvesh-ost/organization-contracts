...
export class OrganizationInterfaceContract extends BaseContract {
    public isOrganization = {
        ...
        > {
            const self = this as any as OrganizationInterfaceContract;
    ...
    public static async deployAsync(
        ...
        logUtils.log(`OrganizationInterface successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new OrganizationInterfaceContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('OrganizationInterface', abi, address, supportedProvider, txDefaults);
